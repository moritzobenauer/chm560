...
if __name__ == '__main__':
    ...
    plt.errorbar(field, np.array(mags)/32**2,yerr=np.array(mags_errors)/32**2, marker='o', markersize=5, ls='-', lw=1, capsize=10)
    plt.xlabel(r'$h / kT$', fontsize=14)
    plt.ylabel(r'$\frac{M}{N}$', fontsize=14)
    plt.tight_layout()
    plt.savefig('figures/hsweep.png', dpi=300)
    plt.show()